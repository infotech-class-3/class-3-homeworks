...
// console.log(`Dizideki tüm insanların ortalama geliri: ${averageSalary}`);
...
//   return age > 30;
// });
// console.log(`Dizideki tüm insanların ortalama geliri: ${averageS}`);
...
const sortedPeopleNames = sortedPeople.map(person => `${person.firstName} ${person.lastName}`);
console.log(sortedPeopleNames);

//5
const departmentCounts = people.reduce((counts, person) => {
