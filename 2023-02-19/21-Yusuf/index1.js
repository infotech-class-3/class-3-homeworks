...
filterMassOver100 = characters.filter((character) => character.mass > 100);
// console.log(filterMassOver100);

//2. Characters with mass less than 200
filterHeightLess200 = characters.filter((character) => character.height < 200);
// console.log(filterHeightLess200);

//3. All male characters
filterMale = characters.filter((character) => character.gender == 'male');
// console.log(filterMale);

//4. All female characters
filterFemale = characters.filter((character) => character.gender == 'female');
